...
loaders_ = {
    ...
    # 'demo' : RGB_demo_loader
}
loader_train = loaders_[opt.testset]
ir, rgb = next(iter(loader_train))
...
if not os.path.exists(output_dir):
    os.mkdir(output_dir)
model_dir = f'/root/autodl-tmp/VIFNet_dehazing/trained_models/vifnet.pk.best.best'
