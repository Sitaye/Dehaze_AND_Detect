...
path = '/root/autodl-tmp/hazy_dataset'           # path to your 'dataset' folder
...
RGB_test_loader = DataLoader(dataset=RGB_Dataset(path+'/test',
                               train=False, size='whole img', format='.png'), batch_size=2, shuffle=False)
# RGB_demo_loader = DataLoader(dataset=RGB_Dataset(path,
#                                train=False, size='whole img', format='.jpg'), batch_size=2, shuffle=False)
